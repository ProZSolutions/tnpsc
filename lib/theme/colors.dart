...
//  static const Color secondaryTextColor = const Color(0xFFBDBDBD);
  ...
  static const Color packagSubTitle = const Color(0xff53575A);

  static const Color packageHeadTitle = const Color(0xff53575A);

  //textfield
  static const Color textFieldUnderLine = const Color(0xFFE5E5E5);
  static const Color profileBoxColor = const Color(0xFFE5E5E5);
  static const Color profileBackGroundColor = const Color(0xFFFBFEFE);

  static const Color profileMember = const Color(0xFF3EB5E3);
  static const Color profileCustomer = const Color(0xFF9FCF67);
  static const Color profileGuest = const Color(0xFFFDBC5F);
